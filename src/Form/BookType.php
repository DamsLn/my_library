...
class BookType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->addEventListener(FormEvents::SUBMIT, $this->setCreatedBy(...))
        ;
    }
    ...
    protected function setCreatedBy(FormEvent $event): void
    {
        $data = $event->getData();

        if (is_null($this->security->getUser())) {
            $event->getForm()->addError(new FormError('Vous devez vous connecter pour ajouter un livre'));
            return;
        }
